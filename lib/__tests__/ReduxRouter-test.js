...
describe('<ReduxRouter>', function () {
  ...
  function renderApp() {
    var route = arguments.length <= 0 || arguments[0] === undefined ? '/parent/child/123?key=value' : arguments[0];
  ...
  it('persists a hash fragment in the URL', function () {
    var tree = renderApp('/parent/child/123#hash');
